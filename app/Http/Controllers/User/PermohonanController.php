...
class PermohonanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $permohonan = DB::transaction(function () use ($data, $request) {
            ...
            $permohonan = Permohonan::create([
                ...
                'scan_ktp_ahli_waris' => $isDarurat ? null : $this->storeUploadedFile($request, 'scan_ktp_ahli_waris', 'permohonan/ktp'),
                'scan_kk' => $isDarurat ? null : $this->storeUploadedFile($request, 'scan_kk', 'permohonan/kk'),
                'surat_kematian' => $isDarurat ? null : $this->storeUploadedFile($request, 'surat_kematian', 'permohonan/surat-kematian'),
    ...
    private function validateStoreRequest(Request $request): array
    {
        return $request->validate([
            ...
            'makam_id' => ['nullable', 'exists:makams,id'],
            'tahun_pemakaman' => ['nullable', 'digits:4'],
            'catatan' => ['required_if:jenis_permohonan,' . Permohonan::JENIS_DARURAT, 'nullable', 'string'],
            'scan_ktp_ahli_waris' => [
            ...
            'catatan.required_if' => 'Keterangan/catatan wajib diisi untuk permohonan darurat.',
            'scan_ktp_ahli_waris.required' => 'Scan KTP ahli waris wajib diunggah.',
