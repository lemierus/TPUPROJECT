            ...
            <form action="{{ route('user.permohonan.update', $permohonan) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3 mt-1">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="makam_id" class="form-select">
                            ...
                            @foreach($makams as $makam)
                                <option value="{{ $makam->id }}" @selected(old('makam_id', $permohonan->makam_id) == $makam->id)>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="tahun_pemakaman" class="form-control" value="{{ old('tahun_pemakaman', $permohonan->tahun_pemakaman) }}" min="1900" max="{{ now()->year }}">
                    </div>
                </div>
                @endif
