                ...
                <div id="section-data-makam" class="jenis-section" style="display: {{ $isPerpanjangan ? 'block' : 'none' }};">
                    <div class="row g-3 mt-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="makam_id" name="makam_id" class="form-select @error('makam_id') is-invalid @enderror">
                                ...
                                @foreach($makams as $makam)
                                    <option value="{{ $makam->id }}" data-kode="{{ $makam->kode_makam }}" data-blok="{{ $makam->blok }}" data-zona="{{ $makam->zona }}" data-nomor="{{ $makam->nomor }}" @selected(old('makam_id') == $makam->id)>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="no_makam" class="form-control @error('no_makam') is-invalid @enderror" value="{{ old('no_makam') }}">
                            @error('no_makam')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="col-md-4">
                            <label class="form-label">Blok / Zona Makam</label>
                            <input type="text" name="blok_zona_makam" class="form-control @error('blok_zona_makam') is-invalid @enderror" value="{{ old('blok_zona_makam') }}">
                            @error('blok_zona_makam')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="col-md-4">
                            <label class="form-label">Tahun Pemakaman</label>
                            <input type="number" name="tahun_pemakaman" class="form-control @error('tahun_pemakaman') is-invalid @enderror" value="{{ old('tahun_pemakaman') }}" min="1900" max="{{ now()->year }}">
...
function syncMakamFields() {
    ...
    if (!makamSelect || !kodeMakam || !blok || !zona || !nomorMakam) {
        return;
    }
